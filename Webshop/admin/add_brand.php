...
<html ng-app="webShopApp">
    ...
    <body ng-controller="cat_brand_ControllerAdmin">
        ...
        <div class="col-lg-12 table">
            <form action="scripts/php/insert_brand.php" method="post" enctype="multipart/form-data">
                    
                <table align="center" width="800px">
                        <tr align="center">
                            <th colspan="2">DODAJ NOVOG PROIZVOĐAČA</th>
                        </tr>

                        <tr>
                            <th>Ime Kategorije:</th>
                            <td align="center"><input type="text" name="brand_name" required></td>
                        </tr>

                        <tr>
                            <td align="center" colspan="2"><input type="submit" name="insert_brand" value="Dodaj proizvođača"></td>
                        </tr>
                </table>
