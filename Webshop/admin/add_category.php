...
<html ng-app="webShopApp">
    ...
    <body ng-controller="cat_brand_ControllerAdmin">
        ...
        <div class="col-lg-12 table">
            <form action="scripts/php/insert_cat.php" method="post" enctype="multipart/form-data">
                ...
                <table align="center" width="800px">
                        ...
                        <tr>
                            ...
                            <td align="center"><input type="text" name="cat_name" required></td>
                        </tr>

                        <tr>
                            <td align="center" colspan="2"><input type="submit" name="insert_cat" value="Dodaj kategoriju"></td>
                        </tr>
                </table>
