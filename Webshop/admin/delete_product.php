...
<?php
    ...
    include "scripts/php/deleteProduct.php";
    
    session_start();

    if(isset($_GET['delete_product_id'])) {
        $_SESSION['remove'] = $_GET['delete_product_id'];
        deleteProduct();
    }
...
<html ng-app="webShopApp">
    ...
    <body ng-controller="products_ControllerAdmin">
        <div class="menu_bar">
            <div class="row">
        ...
        <div class="cart_wrapper" ng-controller="products_ControllerAdmin">
            <div ng-repeat="pro in products track by $index">
                <div class="row custom_cart">
                    <div class="col-lg-2">
                        <img ng-src="images/product_images/{{pro.ProductImage}}" alt="" width="150px" height="150px">
                    </div>
                    <div class="col-lg-7">
                        <a href="details.php?pro_id={{pro.ProductID}}"><h2>{{pro.ProductName}}</h2></a>
                    </div>
                    <div class="col-lg-2">
                        <p>{{pro.ProductPrice}} kn</p>
                    </div>
                    <div class="col-lg-1">
                        <a href="delete_product.php?delete_product_id={{pro.ProductID}}"><i class="fa fa-times"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="scripts/js/products_ControllerAdmin.js"></script>
    </body>
</html>
