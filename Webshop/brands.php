...
<?php
    ...
    session_start();
    $_SESSION['brand_id'] = $_GET['brand_id'];
    $id1 = $_SESSION['brand_id'];
    ...
    $query = "select * from brands where BrandID = '$id1'";
...
<body>
    ...
    <div class="header">
        <h1><?php echo $brandID ?></h1>
    </div>

    <div class="main_wrapper">
        <div class="row" ng-controller="products_Controller">
            <div class="col-lg-4" ng-repeat="p in brandProducts">
