...
<body>
    ...
    <div class="col-lg-12">
        <div>
            <div>
                <h3>Kontaktirajte nas i odgovorit ćemo u najkraćem mogućem roku.</h3>
            </div>
            <div class="form-contact">
                <form action="scripts/php/email_form.php" method="post">
                    <input id="contact-inputA" type="text" name="name" placeholder="Ime..."><br>
                    <input id="contact-inputB" type="text" name="subject" placeholder="Naslov..."><br>
                    <input id="contact-inputC" type="email" name="email" placeholder="Vaša e-mail adresa..."><br>
                    <textarea class="contact-textarea" name="message" placeholder="Poruka..."></textarea><br>
                    <button class="btn btn-primary contact-button" type="submit">Pošalji upit</button>
                </form>
            </div>
        </div>
    </div>
