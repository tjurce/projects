...
<body>
    ...
    <div class="img-header" ng-controller="slide_Controller">
        <div>
            <a ng-href="{{slides[index].link}}"><img ng-src="{{slides[index].image}}" alt="" width="800px" height="600px"></a>
        </div>
        <div class="buttons">
            <i class="fa fa-chevron-left" ng-click="changeContentLeft(index)"></i>
            <i class="fa fa-chevron-right" ng-click="changeContentRight(index)"></i>
        </div>
    </div>
